<template>
  <b-navbar toggleable="md" class="d-block d-md-flex border-top-0 border-left-0 border-right-0 border-bottom">
    <div class="container">
      <b-navbar-brand href="/">
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav class="flex-md-grow-1 flex-wrap w-100">
          <b-nav-item v-for="(item, idx) in mainMenu" :key="idx" :to="item.to">
            {{ item.title }}
          </b-nav-item>
        </b-navbar-nav>
