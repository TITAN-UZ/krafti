                ...
                <div class="row">
                  <div class="col-12 col-xl-5">
                    <div class="about__text">
                      <p>
                        Привет! Мы — KRAFTi, новое слово в онлайн-обучении. Мы верим, что в каждом ребёнке живёт настоящий творец, а в каждом взрослом — настоящий ребёнок. Именно поэтому творческое и
                        интеллектуальное развитие взрослых и детей стало нашей страстью!
                      </p>
                      <p>
                        Мы не просто обучаем, мы раскрываем потенциал. Мы создаём невероятно увлекательные и насыщенные курсы по уникальной методике. Мы назвали её «Методика непрерывного обучения». Мы
                        верим, что интересное обучение не только обогащает знаниями, но и способно изменить мировоззрение. Создать для детей преимущество в предстоящей большой жизни и вернуть взрослым
                        ощущение творческого полёта.
                      </p>
        ...
        <div class="row container__940">
          ...
          <div class="col-lg-6 col-12 d-flex align-items-end">
            <form class="subscription-form" @submit.prevent="onSubscribe">
              <label for="email">
                <input id="email" v-model="subscriber" type="email" placeholder="Введите ваш e-mail" :disabled="loading" />
