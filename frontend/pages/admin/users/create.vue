<template>
  <b-modal id="myModal" title="Новый пользователь" @hidden="onHidden" ref="modalWindow" size="lg" hide-footer visible static>
    <b-form ref="modalForm" @submit.prevent="onSubmit">
      ...
      <b-form-checkbox class="offset-md-3" v-model.number="record.active">Активен</b-form-checkbox>
